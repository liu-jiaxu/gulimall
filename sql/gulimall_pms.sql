...
(
    ...
    img_url              varchar(2000) comment '图片地址',
...
(
    ...
    catelog_id           bigint comment '所属分类id',
    brand_id             bigint comment '品牌id',
    sku_default_img      varchar(2000) comment '默认图片',
...
(
    ...
    member_icon          varchar(2000) comment '用户头像',
