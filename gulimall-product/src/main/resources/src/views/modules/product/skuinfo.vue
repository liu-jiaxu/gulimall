  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('product:skuinfo:delete')" type="danger" @click="deleteHandle()"
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column prop="spuId" header-align="center" align="center" label="spuId">
      </el-table-column>
      <el-table-column prop="skuName" header-align="center" align="center" label="sku名称">
      </el-table-column>
      <el-table-column prop="skuDesc" header-align="center" align="center" label="sku介绍描述">
      </el-table-column>
      ...
      <el-table-column prop="skuTitle" header-align="center" align="center" label="标题">
      </el-table-column>
      <el-table-column prop="skuSubtitle" header-align="center" align="center" label="副标题">
      </el-table-column>
