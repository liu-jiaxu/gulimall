        ...
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
          ...
          <el-table-column prop="icon" header-align="center" align="center" label="组图标">
            <template slot-scope="scope">
              <!-- 组图标回显：字段是 icon（不是 logo），值为上传后返回的 URL，可能是 .ico/.png 等 -->
              <!-- 现代浏览器(Chrome/Edge/Firefox)的 <img> 原生支持显示 .ico，直接赋给 src 即可 -->
              <img :src="scope.row.icon" style="width: 40px; height: 40px; object-fit: contain;">
            </template>
          </el-table-column>
